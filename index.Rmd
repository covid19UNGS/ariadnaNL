---
title: "Modelo de agentes ariadnaNL (NetLogo)"
...
* El modelo esta implemetado en NetLogo 6.11 y las simulaciones se realizan utilzando el entorno **R** y el paquete **nlrx**
...
* Parametros Ajustados con proporción de fallecidos de hospitalizados = 0.0925 proporcion hospitalizados = 0.19 y proporcion de fallecidos sin hospitalizacion = 0.005 
...
![](Figures/Ajuste_CABA 121-139_Fallecidos_log.pdf.png)
![](Figures/Ajuste_CABA 121-139_Hospitalizados.pdf.png)
...
* Para comparación al dia 21/08 la cantidad de camas ocupadas total en CABA = 2691 = 1697+713+281 (Leves+moderados+graves) 
