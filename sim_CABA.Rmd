...
res <- bind_rows(res,res1,res2,res6,res3,res7,res4,res5,res8)
...
nl@experiment <- experiment(expname="world201_Beta39_44_viaje16_23_trabaj51_78_pfhosp59_88",
                            outpath=outpath,
                            repetition=1,
                            tickmetrics="true",
                            idsetup="setup",
                            ...
                            runtime=365,
                            metrics=c("count personas", "nro-hospitalizados", "nro-recuperados", "nro-fallecidos","nro-casos-sintomaticos" ),
                            variables = list("beta" = list(values=c(0.397,0.408,0.407,0.44)),
                                             "Horas-en-viaje" = list(values=c(1.984,2.356,1.553,1.6)),
                                             "Horas-en-trabajo"=list(values=c(5.293,5.129,5.313,7.87)),
                                             "Proporcion-fallecimiento-hospitalizados"=list(values=c(0.059,0.07,0.088,0.08))
                                             ),
                            constants = list("world-width" = 201,
                                             "world-height" = 201,
                                             "infectados-iniciales" = 10,
...
nl@experiment <- experiment(expname="world201_Beta41_viaje1_2_trabaj4_75_pfhosp58",
                            ...
                            variables = list("beta" = list(values=c(0.41,0.41,0.41,0.41)),
                              ...
                              "Proporcion-fallecimiento-hospitalizados"=list(values=c(0.058,0.058,0.058,0.058))
                                             ),
                            constants = list("world-width" = 201,
                                             "world-height" = 201,
                                             "infectados-iniciales" = 10,
...
res <- read_netlogo_simul("Simulations/world201_Beta39_44_viaje16_23_trabaj51_78_pfhosp59_88_distinct.csv",skip = 0) %>% 
                                                mutate(prop_fallecidos = nro_fallecidos / max(count_personas), 
                                                casos = nro_fallecidos+ nro_recuperados, 
                                                fatalidad = nro_fallecidos / casos * 100, poblacion=max(count_personas),
                                                prop_casos=casos/poblacion,prop_camas=capacidad_de_camas/poblacion, 
