...
nl@experiment <- experiment(expname="world201_Beta41_viaje1_2_trabaj4_75_pfhosp09",
                            outpath=outpath,
                            repetition=1,
                            tickmetrics="true",
                            idsetup="setup",
                            ...
                            variables = list("beta" = list(values=c(0.41,0.41,0.41,0.41)),
                                             "Horas-en-viaje" = list(values=c(2.74,2.74,2.74,1)),
                                             "Horas-en-trabajo"=list(values=c(7.5,5,2.11,2.11))
                                             ),
                            constants = list("world-width" = 201,
                                             "world-height" = 201,
                                             "infectados-iniciales" = 10,
