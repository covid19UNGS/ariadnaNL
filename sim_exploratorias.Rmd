...
ggplot( res_tot %>% mutate(R0=beta*5), aes(step,nro_fallecidos, colour=factor(Horas_en_viaje))) + geom_point(size=0.1) + facet_grid(poblacion ~ R0) + scale_color_viridis_d(name="Horas de viaje") + theme(legend.position="bottom") + xlab("Dias") 
